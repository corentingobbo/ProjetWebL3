...
function loadData($scope) { // Fonction de traitement des données 
        $.getJSON('data/testAbonnements.json', (data) => { // Chargement des données test
            $scope.abos = data; // Je les mets dans container 
        });
        $.getJSON('data/testProche.json', (data) => { // Chargement des données test
            $scope.proches = data;
        });
        $.getJSON('data/testTrend.json', (data) => { // Chargement des données test
